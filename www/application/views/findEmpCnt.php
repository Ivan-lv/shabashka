        ...
        <div class="formLine2">
            <p >Сортировать: &nbsp;&nbsp;&nbsp;&nbsp;
                <label class="js-rb js-rb-sel" style="padding-right: 12px">
                    <input type="radio" value="orders_complete" hidden="true" name="group1" checked style="display: none;"/>
                    по количеству заказов
                </label>
                <label class="js-rb" style="padding-right: 12px">
                    <input type="radio" value="rating" hidden="true" name="group1" style="display: none;"/>
                    по рейтингу
                </label>
                <!--                <label class="js-rb">-->
...
<script src="<?php echo base_url('js/findEmp.js')?>"></script>